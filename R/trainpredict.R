...
#' @param testexpr gene by sample expresion matrix for model testing
#' @param trainmeth CpG by sample DNA methylation matrix for model training
#' @param clunumlist number of clusters for the genes, selected from c(1000,2500,5000)
#' @param lambdalist lambda value for Ridge regression, selected from  c(10^c(-1,0,1)) 
#' @examples
#' data(demo_expr)
